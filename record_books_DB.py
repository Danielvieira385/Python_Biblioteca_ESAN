...
dirEmprestimos = os.path.join(current_dir, 'emprestimos_DB.csv')
dirFilaEspera = os.path.join(current_dir, 'fila_espera_DB.csv')
...
def recordBook(autor, title_book, genero_book, publish_date):
    ...
    # Só grava no arquivo se todas as informações forem válidas
    if len(book_info) == 4:
